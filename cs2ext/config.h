...
public:
    static bool save(const std::string& path) {
        ...
        write(f, "radar_hide_spotted",    g_settings.radar_hide_spotted);
        write(f, "radar_size", g_settings.radar_size);
        write(f, "radar_zoom", g_settings.radar_zoom);
        write(f, "radar_aspect_ratio", g_settings.radar_aspect_ratio);
        write(f, "native_res_w", g_settings.native_res_w);
        write(f, "native_res_h", g_settings.native_res_h);
        write(f, "game_res_w", g_settings.game_res_w);
        write(f, "game_res_h", g_settings.game_res_h);
    ...
    static bool load(const std::string& path) {
        ...
        read(kv, "radar_hide_spotted",    g_settings.radar_hide_spotted);
        read(kv, "radar_size", g_settings.radar_size);
        read(kv, "radar_zoom", g_settings.radar_zoom);
        read(kv, "radar_aspect_ratio", g_settings.radar_aspect_ratio);
        read(kv, "native_res_w", g_settings.native_res_w);
        read(kv, "native_res_h", g_settings.native_res_h);
        read(kv, "game_res_w", g_settings.game_res_w);
        read(kv, "game_res_h", g_settings.game_res_h);
